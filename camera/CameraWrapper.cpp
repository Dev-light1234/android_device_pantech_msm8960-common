        ...
        const char *params)
{
    ...
    if(_params.get("iso")) {
        const char* isoMode = _params.get(android::CameraParameters::KEY_QC_ISO_MODE);
        if(strcmp(isoMode, "ISO100") == 0)
            _params.set(android::CameraParameters::KEY_QC_ISO_MODE, "100");
        else if(strcmp(isoMode, "ISO200") == 0)
            _params.set(android::CameraParameters::KEY_QC_ISO_MODE, "200");
        else if(strcmp(isoMode, "ISO400") == 0)
            _params.set(android::CameraParameters::KEY_QC_ISO_MODE, "400");
        else if(strcmp(isoMode, "ISO800") == 0)
            _params.set(android::CameraParameters::KEY_QC_ISO_MODE, "800");
        else if(strcmp(isoMode, "ISO1600") == 0)
            _params.set(android::CameraParameters::KEY_QC_ISO_MODE, "1600");
    }
    
    if (id != 1) {
	_params.set(android::CameraParameters::KEY_QC_ZSL, isVideo ? "off" : "on");
...
static char *camera_get_parameters(struct camera_device *device)
{
    ...
    // fix params here
    _params.set(android::CameraParameters::KEY_QC_SUPPORTED_ISO_MODES, iso_values[id]);
